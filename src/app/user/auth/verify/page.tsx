...
export default function VerifyTempPasswordPage() {
  ...
  useEffect(() => {
    ...
    console.log('Verify temp password page params:', { next, isNewUser, isMagicLink, error });
    ...
    const checkSession = async () => {
      try {
        ...
        if (session && mounted) {
          console.log('Found session for temp password verification:', session.user.email);
          setSession(session);
